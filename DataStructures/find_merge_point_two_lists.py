...
memory location. It is guaranteed that the two head nodes will be different and neither will be NULL. If the
lists share a common node, return that node's data value.
"""
